...
import { malthonData } from "@/data/malthonData";
...
const BloodDonationSection = ({ lang }: Props) => {
  ...
  // ✅ FIX: events separate
  const events = malthonData.events;
  ...
  return (
    <div className="w-full  bg-transparent md:pt-28 pt-20">
     ...
     <SectionHeading
  title={lang === "hi" ? "मालथौन गौरव समारोह" : "Malthon Pride Celebration"}
  subtitle={
    lang === "hi"
      ? "सांस्कृतिक एवं सामाजिक गौरव"
