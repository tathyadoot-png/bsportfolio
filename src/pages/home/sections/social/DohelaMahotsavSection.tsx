...
import { motion, AnimatePresence } from "framer-motion";
 import { dohelaData } from "@/data/dohelaData";
...
const BloodDonationSection = ({ lang }: Props) => {
  ...
  // ✅ FIX: events separate
  const events = dohelaData.events;
  ...
  return (
    <div className="w-full md:pt-28 pt-20 bg-transparent">
      ...
      <div className="w-[94%] lg:w-[88%] mx-auto">
       ...
       <SectionHeading
   title={lang === "hi" ? "दोहेला महोत्सव" : "Dohela Mahotsav"}
  subtitle={
    lang === "hi"
      ? "तीन दिवसीय सांस्कृतिक एवं गौरवशाली आयोजन"
      : "A Three-Day Celebration of Culture & Heritage"
  }
  lang={lang}
/>

          <p className="text-primary font-bold text-lg ">
            {dohelaData.highlight[lang]}
          </p>
        </div>
