...
import { bandariData } from "@/data/bandariData";
...
const BloodDonationSection = ({ lang }: Props) => {
  ...
  // ✅ FIX: events separate
  const events = bandariData.events;
  ...
  return (
    <div className="w-full  bg-transparent pt-20 md:pt-28">
      ...
      <div className="w-[94%] lg:w-[88%] mx-auto">
        ...
        <div className="mb-9 text-center">
            <SectionHeading
  title={lang === "hi" ? "बाँदरी गौरव दिवस" : "Bandari Gaurav Diwas"}
  subtitle={lang === "hi" ? "सांस्कृतिक एवं गौरवशाली उत्सव" : "A Celebration of Culture & Pride"}
  lang={lang}
/>

          <p className="text-primary font-bold text-lg ">
            {bandariData.highlight[lang]}
          </p>
        </div>
