...
import { motion, AnimatePresence } from "framer-motion";
 import { barodiyaData } from "@/data/barodiyaData";
...
const BloodDonationSection = ({ lang }: Props) => {
  ...
  // ✅ FIX: events separate
  const events = barodiyaData.events;
    ...
    <div className="w-full  bg-transparent">
      ...
      <div className="w-[94%] lg:w-[88%] mx-auto">
        ...
        <div className="mb-9 text-center">
          <SectionHeading
  title={lang === "hi" ? "बरोदिया कलां गौरव दिवस" : "Barodiya Kalan Gaurav Diwas"}
  subtitle={
    lang === "hi"
      ? "सांस्कृतिक एवं गौरवशाली उत्सव"
      : "A Celebration of Culture & Pride"
  }
  lang={lang}
/>

          <p className="text-primary font-bold text-lg ">
            {barodiyaData.highlight[lang]}
          </p>
        </div>
